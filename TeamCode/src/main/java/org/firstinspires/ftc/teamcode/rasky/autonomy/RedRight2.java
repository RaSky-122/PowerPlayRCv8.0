 ...
 * @version 1.0
 */
@Autonomous(name = "Red Right Sec", group = "tests")
public class RedRight2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence startTraj = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .splineToSplineHeading(new Pose2d(36, -30, Math.toRadians(-70)), Math.toRadians(90))
                .setVelConstraint(velCon)
                .splineToSplineHeading(new Pose2d(28, -5, Math.toRadians(-48)), Math.toRadians(150))
                .build();
        ...
        TrajectorySequence twoTraj = drive.trajectorySequenceBuilder(startTraj.end())
                ...
                .splineToLinearHeading(new Pose2d(60, -11, Math.toRadians(0)), Math.toRadians(0))
                .build();

        TrajectorySequence threeTraj = drive.trajectorySequenceBuilder(twoTraj.end())
                .setReversed(true)
                .addTemporalMarker(() -> {
                    target = (int) LiftSystem.LiftPositions.MEDIUM_JUNCTION.position;
                })
                .addTemporalMarker(0.3, () -> {
                    servoAxle.setPosition(LiftSystem.LiftPositions.HIGH_JUNCTION.axlePos);
                    servoJoint.setPosition(LiftNewClaw.JointModes.BACK.position);
                })
                .lineToLinearHeading(new Pose2d(26, -17, Math.toRadians(30)))
                .build();
        ...
        TrajectorySequence fourTraj = drive.trajectorySequenceBuilder(threeTraj.end())
                ...
                .splineToLinearHeading(new Pose2d(59.5, -10, Math.toRadians(0)), Math.toRadians(0))
                .build();
        ...
        TrajectorySequence nineTraj = drive.trajectorySequenceBuilder(eightTraj.end())
                ...
                .lineToLinearHeading(new Pose2d(26, -16.5, Math.toRadians(30)))
                .build();
        ...
        TrajectorySequence elevenTraj = drive.trajectorySequenceBuilder(tenTraj.end())
                ...
                .lineToLinearHeading(new Pose2d(26, -15.5, Math.toRadians(40)))
                .build();
        ...
        TrajectorySequence parkZoneOne = drive.trajectorySequenceBuilder(elevenTraj.end())
                ...
                .lineToLinearHeading(new Pose2d(12, -12.5, Math.toRadians(90)))
                .build();
        ...
        TrajectorySequence parkZoneTwo = drive.trajectorySequenceBuilder(elevenTraj.end())
                ...
                .lineToLinearHeading(new Pose2d(35, -12.5, Math.toRadians(90)))
                .build();
        ...
        TrajectorySequence parkZoneThree = drive.trajectorySequenceBuilder(elevenTraj.end())
                ...
                .lineToLinearHeading(new Pose2d(57, -12.5, Math.toRadians(90)))
                .build();
